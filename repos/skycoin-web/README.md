# `skycoin/skycoin-web` repo-info

This directory contains additional information about the published artifacts of [the `skycoin/skycoin-web` image](https://hub.docker.com/r/skycoin/skycoin-web).
