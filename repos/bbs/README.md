# `skycoin/bbs` repo-info

This directory contains additional information about the published artifacts of [the `skycoin/bbs` image](https://hub.docker.com/r/skycoin/bbs).
